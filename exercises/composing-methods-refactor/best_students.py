...
class School:
    ...
    def process_graduation(self):
        ...
        self.message(passed_students)

        # Find the top 10% of them and send their contact to the top employers
        self.top_student(passed_students)


    def message(self,passed_students):
    ...
    def top_student(self,passed_students):
...
students = [Student(2.1, 'donald'), Student(2.3, 'william'), Student(2.7, 'toro'), Student(3.9, 'lili'), Student(3.2,'kami'), Student(3,'sarah')]
