...
caluculated_eye_size = (math.pi*iris_width/2*iris_height/2) / eye_size >= 0.69

height_divided_width = eye_height/eye_width >= 0.59


if eye_size > 0.45 and caluculated_eye_size and height_divided_width:
