...
def lacking_ingredients(ingredients) :
    return ('cucumber' not in ingredients or 'tomato' not in ingredients or 'onion' not in ingredients or 'lemon juice' not in ingredients)
