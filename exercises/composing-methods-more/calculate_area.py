...
def calulate_area_under_graph(graph):   # TODO: Rename this function to reflect what it's doing.
...
def get_largest_value(li):  # TODO: Rename this function to reflect what it's doing.
    m = li[0]
    for value in li:
        if value > m:
            m = value
